<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_university_list.aspx.cs" Inherits="ThesisProject_.userViews.user_university_list" %>
            ...
            <div class="container-fluid">
                <h2 class="table-title"> Universities List</h2>
                    <form id="form1" runat="server">
                        <h1 class="userPageTitle">University List</h1>
