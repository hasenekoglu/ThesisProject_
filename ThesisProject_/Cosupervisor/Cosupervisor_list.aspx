<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cosupervisor_list.aspx.cs" Inherits="ThesisProject_.Cosupervisor.Cosupervisor_list" %>
                                ...
                                <asp:Repeater runat="server" ID="Cosupervisorlist"> 
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Eval("EMAIL") %></td>
                                            <td>
                                                 <asp:HyperLink NavigateUrl='<%# "cosupervisor_delete.aspx?id=" + Eval("ID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                                                 <asp:HyperLink NavigateUrl='<%# "cosupervisor_edit.aspx?id=" + Eval("ID") %>' runat="server" CssClass="btn btn-success">Edit</asp:HyperLink>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
