<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="languages_list.aspx.cs" Inherits="ThesisProject_.languages.languages__list" %>
            ...
            <div class="container-fluid">
              <form id="form2" runat="server">
                  ...
                  <tr>
                   ...
                   <td><%# Eval("LANGUAGE") %></td>
                   <td>
                       <asp:HyperLink NavigateUrl='<%# "languages_delete.aspx?id=" + Eval("ID") %>' runat="server" CssClass="btn btn-danger">Delete</asp:HyperLink>
                  </td>
                 </tr>    
               </ItemTemplate>
           </asp:Repeater>
